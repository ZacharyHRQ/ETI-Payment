...
CREATE TABLE Transactions (TransactionId string  PRIMARY KEY, TransactionTimeStamp TIMESTAMP DEFAULT NOW(), SenderWalletId VARCHAR(120), ReceiverWalletId VARCHAR(120), TokenId VARCHAR(8), NumTokens int); 
